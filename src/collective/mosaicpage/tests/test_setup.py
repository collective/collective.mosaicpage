...
from collective.mosaicpage.testing import COLLECTIVE_MOSAICPAGE_INTEGRATION_TESTING  # noqa: E501
...
class TestSetup(unittest.TestCase):
    ...
    def test_browserlayer(self):
        ...
        from collective.mosaicpage.interfaces import (
            ICollectiveMosaicpageLayer)
